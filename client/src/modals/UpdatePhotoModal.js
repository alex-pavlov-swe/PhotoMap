...
const mapDispatchToProps = (dispatch) => ({
    updatePhotoMongo: (id) => dispatch(updatePhotoMongo(id)),
	getPhotoById: (id) => dispatch(getPhotoById(id)),
	deletePhotoFromFirebase: (id) => dispatch(deletePhotoFromFirebase(id)),
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(UpdatePhoto));
